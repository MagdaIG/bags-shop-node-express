...
router.get('/', async (req, res) => {
  try {
    ...
    console.error('Error en p胓ina principal:', error);
    res.render('index', {
      title: 'Handmade Bags Store',
      stats: { totalUsers: 0, totalOrders: 0 },
      recentOrders: [],
      error: 'Error al cargar estad铆sticas'
    });
  }
});
...
// Vista de pedidos de un usuario espec铆fico
